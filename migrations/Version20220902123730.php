 ...
 */
final class Version20220902123730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contact AS SELECT id, name, email, string, subject, content, created_at FROM contact');
        ...
        $this->addSql('INSERT INTO contact (id, name, email, phone, subject, content, created_at) SELECT id, name, email, string, subject, content, created_at FROM __temp__contact');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE contact');
        $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, string VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, content CLOB NOT NULL, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO contact (id, name, email, string, subject, content, created_at) SELECT id, name, email, phone, subject, content, created_at FROM __temp__contact');
        $this->addSql('DROP TABLE __temp__contact');
        $this->addSql('DROP INDEX IDX_F5299398A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, reference, full_name, carrier_name, carrier_price, delivery_address, is_paid, more_informations, created_at, quantity, sub_total_ht, taxe, sub_total_ttc, stripe_checkout_session_id FROM "order"');
        $this->addSql('DROP TABLE "order"');
